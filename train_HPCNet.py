...
if __name__ == "__main__":
    opt = Config('training_HPCNet.yml')
    ...
    scheduler = optim.lr_scheduler.StepLR(step_size=60, gamma=0.8,
    ...
    val_loader = DataLoader(dataset=val_dataset, batch_size=4, shuffle=False, num_workers=1, drop_last=False,
                            pin_memory=True)
